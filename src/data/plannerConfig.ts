...
export const sharedConfig: Partial<PlannerConfig> = {
    ...
    "dinnerMenu": [
        { "title": "冷菜", "items": ["精美四冷"] },
        {
            "title": "热菜",
            "items": [
                "美极鲜白条鱼", "白灼南美大虾", "地锅跑山鸡", "金汤羊蝎子",
                "徽州腊鲜笋", "黄标牛肉", "外婆蒸土鸡蛋", "山药木耳",
                "蒿子咸肉丝", "高山有机青菜"
            ]
        },
        { "title": "汤类", "items": ["酸萝卜老鸭汤（切块）"] },
        { "title": "甜品", "items": ["红糖糍粑", "精美果盘", "饮料2瓶"] }
    ],
    "cart": {
        "horse-creativity": 28,
        "cat-blindbox": 28,
    ...
    "prizeEdits": {
        "prize-grand": { "name": "特等奖", "spec": "大奖", "unit": "个", "price": 800 },
        "prize-1": { "name": "一等奖", "spec": "大奖", "unit": "个", "price": 500 },
        "prize-2": { "name": "二等奖", "spec": "大奖", "unit": "个", "price": 150 },
        "prize-3": { "name": "三等奖 导演小组抽", "spec": "大奖", "unit": "个", "price": 50 }
    },
    "customRedEnvelopes": [
        { "id": "custom-red-envelope-1768748845499", "category": "RedEnvelope", "name": "足球冠军红包", "unit": "1", "spec": "现金", "price": 800 },
        { "id": "custom-red-envelope-1768748870031", "category": "RedEnvelope", "name": "足球亚军红包", "unit": "个", "spec": "现金", "price": 400 },
        { "id": "custom-red-envelope-1768748892512", "category": "RedEnvelope", "name": "三四名红包", "unit": "1", "spec": "现金", "price": 200 },
        { "id": "custom-red-envelope-1768748955405", "category": "RedEnvelope", "name": "剩下三名红包", "unit": "1", "spec": "现金", "price": 100 }
    ],
    "redEnvelopeEdits": {},
    "itemEdits": {}
};
